...
@ControllerAdvice
public class BoardGameSharingSystemExceptionHandler {
	@ExceptionHandler(BoardGameSharingSystemException.class)
	public ResponseEntity<ErrorDto> handleEventRegistrationException(BoardGameSharingSystemException e) {
